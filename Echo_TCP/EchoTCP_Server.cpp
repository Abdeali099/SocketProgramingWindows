...
printf("\n Received data from %s : port %d : %s \n", inet_ntoa(clientAddrStruct.sin_addr),ntohs(clientAddrStruct.sin_port), msgOfClient);
       ...
       // cout<<"clientAddrStruct.sin_port = "<<clientAddrStruct.sin_port<<endl;
        ...
        // cout<<"htons( clientAddrStruct.sin_port ) = "<<htons( clientAddrStruct.sin_port )<<endl;
                        ...
                        sendStatus = send(acceptedSocket, msgOfClient, strlen(msgOfClient), 0);
                        ...
                        if(strcmp(msgOfClient,"Bye")==0 || strcmp(msgOfClient,"bye")==0){
                            printf("\n Server is Closed !! ");
                            break;
                        }
